...
# '不明'
adb shell pm uninstall -k --user 0 com.nttdocomo.android.gs.utility
...
# '不明'
adb shell pm uninstall -k --user 0 com.nttdocomo.android.keyguard
# メディアプレーヤー
...
# eブック
adb shell pm uninstall -k --user 0 jp.co.nttdocomo.ebook
# 位置情報(及びサブ)
...
# '不明'
adb shell pm uninstall -k --user 0 com.sonyericsson.android.servicemenu.product.res.overlay.docomo
# 外国語キーボード(中国語)
adb shell pm uninstall -k --user 0 com.sonyericsson.textinput.chinese
# track ID
adb shell pm uninstall -k --user 0 com.sonyericsson.trackid
adb shell pm uninstall -k --user 0 com.sonyericsson.trackid.res.overlay_305
# ビデオ
...
adb shell pm uninstall -k --user 0 com.nextbit.
# Evernote
...
adb shell pm uninstall -k --user 0 com.somc.so05g.manual
# Gガイド番組表
